...
# Disable debug package - QML files don't need debug symbols
...
Summary:        DankMaterialShell CLI tool (git version)
License:        GPL-3.0-only
...
%changelog
* Tue Oct 08 2024 Purian23 <purian23@users.noreply.github.com> - 0.0.git.1169.9f3685e4-1
